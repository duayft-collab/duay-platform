...
window._pdfBankaListesi = function(paraBirimi) {
  ...
  var sonuc = IBAN_DATA.map(function(item) {
    return {
      ...
      hesapSahibi: item.hesapSahibi || (window.SIRKET_DATA && window.SIRKET_DATA.hesapSahibi) || (window.PI_ADRES?.unvanTR) || 'Duay Uluslararası Ticaret Ltd. Şti.',
      paraBirimi: pb
    };
...
window._pdfOrtakFooter = function(stil) {
  ...
  var sirket = p.sirket || (window.SIRKET_DATA && window.SIRKET_DATA.unvan_en) || 'Duay Global LLC';
