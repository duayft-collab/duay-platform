...
window._saV2TeklifOlustur = function(id) {
  ...
  ic += '<div style="border:0.5px solid var(--b);border-radius:6px;overflow:hidden;margin:0 16px 8px;display:grid;grid-template-columns:2fr 1fr;gap:0">';
  ic += '<div>';
  ...
  ic += '<div id="st-sartlar-liste" style="padding:6px 10px;max-height:120px;overflow-y:auto"></div>';
  ic += '</div>';
  ic += '<div style="display:flex;flex-direction:column;justify-content:center;gap:6px;padding:8px 10px;border-left:0.5px solid var(--b)">';
  ...
  ic += '<button onclick="event.stopPropagation();window._saV2SartManuelEkle()" style="font-size:10px;padding:4px 10px;border:0.5px solid var(--b);border-radius:4px;background:transparent;cursor:pointer;font-family:inherit;color:var(--t2)">Ekle</button></div></div></div>';
