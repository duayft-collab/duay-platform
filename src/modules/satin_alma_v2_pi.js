...
window._piTasarimA = function(t, bugun, satirlar, katman, gizliKod, L) {
  ...
  h += '</tr></thead><tbody>';
  satirlar.forEach(function(s) { h += '<tr><td style="color:#aaa">' + s.no + '</td><td><div style="font-weight:500">' + s.ad + '</div><div style="font-size:9px;color:#888">' + s.kod + '</div>' + (s.eskiKod?'<div style="font-size:9px;color:#888">'+(L.eskiKod||'Old Code')+': '+s.eskiKod+'</div>':'') + '</td><td>' + s.miktar + '</td><td>' + s.birim + '</td><td style="text-align:right">$' + Number(s.satisF || 0).toLocaleString('tr-TR', {minimumFractionDigits:2, maximumFractionDigits:2}) + '</td><td style="text-align:right;font-weight:500">$' + Number(s.toplam || 0).toLocaleString('tr-TR', {minimumFractionDigits:2, maximumFractionDigits:2}) + '</td></tr>'; });
  h += '</tbody></table></div>';
...
window._piTasarimB = function(t, bugun, satirlar, katman, gizliKod, L) {
  ...
  h += '</tr></thead><tbody>';
  satirlar.forEach(function(s) { h += '<tr><td style="color:#aaa">' + s.no + '</td><td><div style="font-weight:500">' + s.ad + '</div><div style="font-size:9px;color:#888">' + s.kod + '</div>' + (s.eskiKod?'<div style="font-size:9px;color:#888">'+(L.eskiKod||'Old Code')+': '+s.eskiKod+'</div>':'') + '</td><td>' + s.miktar + '</td><td>' + s.birim + '</td><td style="text-align:right">$' + Number(s.satisF || 0).toLocaleString('tr-TR', {minimumFractionDigits:2, maximumFractionDigits:2}) + '</td><td style="text-align:right;font-weight:500;color:#185FA5">$' + Number(s.toplam || 0).toLocaleString('tr-TR', {minimumFractionDigits:2, maximumFractionDigits:2}) + '</td></tr>'; });
  h += '</tbody></table></div>';
...
window._piTasarimC = function(t, bugun, satirlar, katman, gizliKod, L) {
  ...
  h += '</tr></thead><tbody>';
  satirlar.forEach(function(s) { h += '<tr><td style="color:#aaa">' + s.no + '</td><td><div style="font-weight:500">' + s.ad + '</div><div style="font-size:9px;color:#888">' + s.kod + '</div>' + (s.eskiKod?'<div style="font-size:9px;color:#888">'+(L.eskiKod||'Old Code')+': '+s.eskiKod+'</div>':'') + '</td><td>' + s.miktar + '</td><td>' + s.birim + '</td><td style="text-align:right">USD ' + Number(s.satisF || 0).toLocaleString('tr-TR', {minimumFractionDigits:2, maximumFractionDigits:2}) + '</td><td style="text-align:right;font-weight:500">' + Number(s.toplam || 0).toLocaleString('tr-TR', {minimumFractionDigits:2, maximumFractionDigits:2}) + '</td></tr>'; });
  h += '</tbody></table>';
...
window._piTasarimI = function(t, bugun, satirlar, katman, gizliKod, L) {
  ...
  var satirHTML = (typeof satirlar === 'string') ? satirlar : (Array.isArray(satirlar) ? satirlar.map(function(s){return '<tr><td style="font-size:9px;padding:4px;color:#aaa">'+s.no+'</td><td style="font-size:9px;padding:4px"><div style="font-weight:600">'+s.ad+'</div><div style="font-size:8px;color:#888">'+s.kod+'</div></td><td style="font-size:9px;padding:4px;text-align:right">'+s.miktar+' '+s.birim+'</td><td style="font-size:9px;padding:4px;text-align:right">$'+Number(s.satisF || 0).toLocaleString('tr-TR', {minimumFractionDigits:2, maximumFractionDigits:2})+'</td><td style="font-size:9px;padding:4px;text-align:right;font-weight:600">$'+Number(s.toplam || 0).toLocaleString('tr-TR', {minimumFractionDigits:2, maximumFractionDigits:2})+'</td></tr>';}).join('') : '');
...
window._piTasarimD1 = function(t, bugun, satirlar, katman, gizliKod, L) {
  ...
  if (tel || mail) html += '<div class="pi-d-brand-sub">' + esc(tel) + (mail ? ' · ' + esc(mail) : '') + '</div>';
  html += '</div>';
  html += '<div>';
