...
window.renderSatinAlmaV2 = function() {
  ...
  h+='<div style="display:grid;grid-template-columns:20px minmax(220px,1fr) 100px 130px 90px 140px 85px 64px;padding:5px 16px;background:var(--color-background-secondary);border-bottom:0.5px solid '+_b+';position:sticky;top:0;z-index:1;height:36px;overflow:hidden">';
