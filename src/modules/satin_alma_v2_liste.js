...
window.renderSatinAlmaV2 = function() {
  ...
  h+='<div style="display:flex;align-items:center;gap:6px;padding:8px 12px;position:sticky;top:46px;z-index:11;background:var(--sf,#fff);border-bottom:0.5px solid '+_b+';overflow-x:auto;flex-wrap:nowrap">';
  ...
  h+='<div style="display:flex;align-items:center;gap:5px;padding:7px 16px;position:sticky;top:84px;z-index:10;background:var(--sf,#fff);border-bottom:0.5px solid '+_b+';overflow-x:auto;flex-wrap:nowrap;flex-shrink:0">';
  ...
  h+='<div style="display:grid;grid-template-columns:20px minmax(220px,1fr) 100px 130px 90px 140px 85px 64px;padding:5px 16px;background:var(--color-background-secondary);border-bottom:0.5px solid '+_b+';position:sticky;top:118px;z-index:9;background:var(--sf,#fff);height:36px;overflow:hidden">';
