...
window._ihrBelgeUretDogrudan = function(dosyaId, tur, lang, yon) {
  ...
  var html = window._ihrBelgeHtml?.(d, tur, 'dis', urunler, { lang: lang, yon: yon || 'portrait' });
