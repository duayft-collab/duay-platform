        ...
        + '<table id="udb-tablo" style="width:100%;border-collapse:collapse;table-layout:fixed;min-width:1500px">'
          ...
          + '<thead id="udb-thead">'
            + '<tr style="background:var(--s2);border-bottom:0.5px solid var(--b)">'
              ...
              + '<th style="padding:8px 4px;font-size:10px;font-weight:600;color:var(--t2);white-space:nowrap;text-align:center">TSL(G)</th>'
              + '<th style="padding:8px 4px;font-size:10px;font-weight:600;color:var(--t2);white-space:nowrap;text-align:center">RAF(G)</th>'
              + '<th style="padding:8px 4px;font-size:10px;font-weight:600;color:var(--t2);white-space:nowrap;text-align:center">NET KG</th>'
              + '<th style="padding:8px 4px;font-size:10px;font-weight:600;color:var(--t2);white-space:nowrap;text-align:center">BRÜT KG</th>'
