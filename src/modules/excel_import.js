...
var DUAY_ALANLARI = [
  { v: 'aciklama',       l: 'Product Description / Ürün Açıklaması', zorunlu: true },
  { v: 'urun_kodu',      l: 'Item Code / Ürün Kodu',                 zorunlu: false },
  { v: 'hs_kodu',        l: 'HS Code / GTIP Kodu',                   zorunlu: false },
  { v: 'miktar',         l: 'Quantity / Miktar (toplam)',             zorunlu: false },
  { v: 'miktar_koli',    l: 'Qty per Carton / Koli Başı Adet',       zorunlu: false },
  { v: 'birim',          l: 'Unit / Birim (PCS, KGS, SET...)',        zorunlu: false },
  { v: 'birim_fiyat',    l: 'Unit Price / Birim Fiyat',              zorunlu: false },
  { v: 'toplam_fiyat',   l: 'Total Amount / Toplam Tutar',           zorunlu: false },
  { v: 'doviz',          l: 'Currency / Para Birimi',                zorunlu: false },
  { v: 'tedarikci',      l: 'Supplier / Tedarikçi',                  zorunlu: false },
  { v: 'brut_kg_koli',   l: 'Gross KG per Carton / Koli Başı Brüt',  zorunlu: false },
  { v: 'net_kg_koli',    l: 'Net KG per Carton / Koli Başı Net',     zorunlu: false },
  { v: 'brut_kg',        l: 'Total Gross KG / Toplam Brüt Ağırlık',  zorunlu: false },
  { v: 'net_kg',         l: 'Total Net KG / Toplam Net Ağırlık',     zorunlu: false },
  { v: 'hacim_m3_koli',  l: 'CBM per Carton / Koli Başı Hacim',      zorunlu: false },
  { v: 'hacim_m3',       l: 'Total CBM / Toplam Hacim (m³)',         zorunlu: false },
  { v: 'koli_adet',      l: 'Carton Qty / Toplam Koli Adedi',        zorunlu: false },
  { v: 'mense_ulke',     l: 'Country of Origin / Menşe Ülke',        zorunlu: false },
  { v: 'etiket_rengi',   l: 'Label Color / Etiket Rengi',            zorunlu: false },
  { v: 'konteyner_sira', l: 'Loading Order / Konteyner Sırası',      zorunlu: false },
  { v: 'siparis_no',     l: 'Order No / Sipariş No',                 zorunlu: false },
  { v: 'marka',          l: 'Brand / Marka',                         zorunlu: false },
  { v: 'model',          l: 'Model',                                 zorunlu: false },
  { v: 'aciklama_tr',    l: 'Türkçe Açıklama',                       zorunlu: false },
  { v: 'durum',          l: 'Status / Durum',                        zorunlu: false },
  { v: 'atla',           l: '— Atla / Skip —',                       zorunlu: false },
];

var ANAHTAR = {
  aciklama:      ['description','descriptionofgoods','productdescription','productname','goodsdescription',
                  'urun','aciklama','tanim','goods','itemname','product','name'],
  urun_kodu:     ['itemcode','itemno','productcode','articleno','article','sku','ref','partnumber',
                  'kod','urunkodu','part','code','no'],
  hs_kodu:       ['hs','hscode','hstariff','tariff','tariffcode','gtip','gumruk','customscode',
                  'harmonized','commodity'],
  miktar:        ['totalqty','totalquantity','totalpieces','totalpcs','qty','quantity','miktar','adet',
                  'amount','pcs','pieces'],
  miktar_koli:   ['qtypercarton','pcspercarton','pcsinctn','pcsinone','pcsperbox','kolibasi',
                  'quantitypercarton','innerqty'],
  birim:         ['unit','unitofmeasure','uom','birim'],
  birim_fiyat:   ['unitprice','pricepcs','priceper','price','fiyat','birimfiyat','cost','unitcost',
                  'ratepcs','rate'],
  toplam_fiyat:  ['totalamount','totalvalue','totalprice','toplamtutar','toplamfiyat',
                  'totaleur','totalusd','totaltry'],
  doviz:         ['currency','cur','doviz','curr'],
  tedarikci:     ['supplier','vendor','manufacturer','tedarikci','uretici','factory','maker'],
  brut_kg_koli:  ['grosspercarton','grossweightpercarton','grossperbox','kgpercarton','brutkolibasi',
                  'grosskg','onecarton'],
  net_kg_koli:   ['netpercarton','netweightpercarton','netperbox','netkolibasi'],
  brut_kg:       ['totalgrosskg','totalgrossweight','grossweighttotal','totalbrut',
                  'brutkg','brutkilogram'],
  net_kg:        ['totalnetkg','totalnetweight','netweighttotal','totalnet',
                  'netkg','netkilogram'],
  hacim_m3_koli: ['cbmpercarton','volumepercarton','cbmperbox','cbmone','hacimkolibasi'],
  hacim_m3:      ['totalcbm','totalvolume','cbmtotal','cbm','volume','hacim','m3','cubicmeter'],
  koli_adet:     ['cartonqty','totalcartons','numberofcartons','ctn','ctns','cartons','boxes',
                  'koliadet','kolisayisi','packages'],
  mense_ulke:    ['countryoforigin','origin','coo','originco','mense','country'],
  etiket_rengi:  ['color','colour','labelcolor','etiket','renk','label'],
  konteyner_sira:['loadingorder','loadingsequence','containerorder','sira','konteyner'],
  siparis_no:    ['orderno','ordernum','po','ponumber','purchaseorder','siparis','siparisno'],
  marka:         ['brand','trademark','marka'],
  model:         ['model','type','tip'],
  durum:         ['status','durum','state']
};
