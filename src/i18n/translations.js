...
let TRANSLATIONS = {
  tr: {
    ...
    /* V192e — TAHKİM: silinen kaydı geri alma (restore) */
    'ed.actionMenu.restore':          '🔄 Geri Al',
    'ed.title.deleted':               'Silinmiş Kayıtlar',
    'ed.toolbar.viewDeleted':         '🗑️ Silinmiş ({n})',
    'ed.confirm.restore.title':       'Kaydı Geri Al?',
    'ed.confirm.restore.body':        'Bu silinmiş kayıt geri alınıp aktif listeye dönecek. Devam edilsin mi?',
    'ed.toast.restored':              'Kayıt başarıyla geri alındı',
    'ed.toast.restoreFailed':         'Geri alma başarısız',
  ...
  en: {
    ...
    /* V192e — TAHKİM: restore deleted record */
    'ed.actionMenu.restore':          '🔄 Restore',
    'ed.title.deleted':               'Deleted Records',
    'ed.toolbar.viewDeleted':         '🗑️ Deleted ({n})',
    'ed.confirm.restore.title':       'Restore Record?',
    'ed.confirm.restore.body':        'This deleted record will be restored to the active list. Continue?',
    'ed.toast.restored':              'Record restored successfully',
    'ed.toast.restoreFailed':         'Restore failed',
