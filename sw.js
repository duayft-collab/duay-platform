...
/* CACHE-BUMP-2026-05-06-V194a V194a MASTER-DATA-FOUNDATION-001: src/core/duay_meta.js genisletildi — DUAY_META Object.freeze, DUAY_KUR_FALLBACK, DUAY_KUR_GET 2. parametre, DUAY_BANKA + DUAY_TERMS frozen return, DUAY_FOOTER + DUAY_META_HEALTH yeni accessor. Davranis uyumlu (mevcut callerlar etkilenmedi). Sadece core/duay_meta.js degisti — eski cache servis edilirse yeni accessorlar undefined olarak dener, bu yuzden bump zorunlu. T2-prev: V194a EDIT 5 */
const CACHE_NAME    = 'duay-platform-v194a';
const CACHE_VERSION = '194.0.0-a';
