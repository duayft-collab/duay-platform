...
/* CACHE-BUMP-2026-05-06-V193e7p1 V193 EDIT 7.1 — PDF FIX: cash_flow_pdf.js boş PDF bug fix. Off-screen container (left:-99999px) html2canvas tarafından render edilemiyordu → görünür-invisible (position:absolute, left:0, top:0, opacity:0, pointer-events:none, z-index:-1). YASAK: display:none, left:-99999px, transform:scale(0). Ek: double-click koruması (_cfpBusy flag), boş veri uyarısı 'PDF oluşturulamadı: raporda veri bulunamadı', loading overlay (CSS spinner). cleanup() helper then/catch/init hepsinde çağrılır — memory leak yok. T2-prev: V193 EDIT 7.1 patch */
const CACHE_NAME    = 'duay-platform-v193e7p1';
const CACHE_VERSION = '193.71.0';
