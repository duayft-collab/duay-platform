...
/* CACHE-BUMP-2026-05-06-V191 V191 LOJISTIK paketi (7 cycle): RBAC silme + Arşiv/Unarchive + Evrak Durumu + 15 gün liman alarmı + HandlingFlags +3 enum + V186 Step 4 redesign. TAHKIM disiplini — V190'dan beri sw.js cache bump yoktu, V191 push edildiğinde kullanıcı tarayıcılarındaki eski JS cache invalidate olsun diye CACHE_NAME bump zorunlu. Aksi halde index.html cache key güncel olsa bile SW eski JS'leri serveler ve V191 görünmez kalır. T2-prev: V191 paket sonu */
const CACHE_NAME    = 'duay-platform-v191';
const CACHE_VERSION = '191.0.0';
