...
/* CACHE-BUMP-2026-05-06-V194b V194b ACIL-VERI-HATASI-FIX-001: 4 modulde P0 veri hatasi duzeltildi — (1) satin_alma_v2_satis.js GBP IBAN bug devre dısı + placeholder IBAN UI silindi, (2) hesap_makinesi.js eski 38.50 kur → 44.55/51.70/59.30, (3) odemeler.js aynı, (4) satis_teklif.js Kuveyt USD/EUR 5001→5000 sapma fix. Accessor migration YOK (V194c). Davranis uyumlu (GBP transfer mesajı degisti). T2-prev: V194a bf7d18b */
const CACHE_NAME    = 'duay-platform-v194b';
const CACHE_VERSION = '194.0.0-b';
