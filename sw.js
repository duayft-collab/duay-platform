...
/* CACHE-BUMP-2026-05-03-V161 SATIN-ALMA-MODAL-FS-NUM-001 V161: 2 modal'a fullscreen + yeni sekme + urun satirlarina sira no badge. (1) sav2-form-modal Yeni Alis Teklifi: header sag ust ⛶ + ↗ ikon, .sav2f-urun-satir satirlarina 1 2 3 numarali badge. (2) mo-urun-db Urun Katalogu Toplu Kayit: ayni patern + tablo TR satirlarina sira no TD. V155 deseni — buton inject + MutationObserver fallback body + per-modal. KX9 form.js + urun_db.js DOKUNULMAZ. KX8 mevcut HTML kopyalanmadi DOM injection. Idempotent v161-fs-btn v161-nt-btn v161-sira-no flag. Yeni dosya satin_alma_v2_modal_fs_x.js 187 satir. T2-prev: 5e4b04b */
const CACHE_NAME    = 'duay-platform-v161';
const CACHE_VERSION = '161.0.0';
